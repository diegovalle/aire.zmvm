...
Because of limitations with the SEDEMA website [http://www.aire.cdmx.gob.mx/](http://www.aire.cdmx.gob.mx/default.php) (where all data downloaded by the aire.zmvm comes from), options for downloading data can be somewhat confusing, but hopefully the following table will serve to make them clearer.

| function                  | date range     | Units    | Wind / Temperature / RH | Earliest Date | Pollutants  | Includes All Stations | Criterion |
|---------------------------|----------------|----------|------------------|------------|------------|-------|-------|
| get_station_data          | years          | Original | Yes              | 1986       | SO2, CO, NO2, O3, PM10, PM25,  WSP, WDR, TMP, RH | Yes | hourly, daily max, daily min |
| get_station_single_month  | 1 month        | Original | Yes              | 2005-01    | SO2, CO, NO2, O3, PM10, PM25,  WSP, WDR, TMP, RH | Yes | hourly |
| get_station_imeca         | 1 day          | IMECA    | No               | 2009-01-01 | SO2, CO, NO2, O3, PM10 | No | hourly |
| get_zone_imeca            | 1 or more days | IMECA    | No               | 2008-01-01 | SO2, CO, NO2, O3, PM10 | Only zones | hourly, daily max |
| get_latest_imeca          | 1 hour         | IMECA    | NO               | Latest only| Max of SO2, CO, NO2, O3, PM10 | No |latest hourly |
