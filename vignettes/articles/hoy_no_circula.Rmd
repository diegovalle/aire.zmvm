...
In an effort to lower pollution levels the Mexico City government introduced in 1989 the *Hoy no circula program* program, a ban on most cars from circulating once a week. But did it really work? 
...
download_data <- function(pollutant) {
  ...
  suppressWarnings({
    o3 <- get_station_data(criterion = "MAXIMOS", # Can be MAXIMOS (daily maximum), 
                           ...
                           year = 1986:2017, # The earliest year allowed is 1986
                           progress = FALSE)
  })
