...
of the time returned by the function. That's because the hour returned by the `get_station_imeca` function comes in a format that is not affected by daylight savings time (UTC+6). To convert to local Mexico City time we can use the following function:
