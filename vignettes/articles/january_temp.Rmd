...
# You could get TMP data accurate to one digit by using get_station_data,
...
Clean the data and only use stations that were reporting 99% of the time during the period under analysis.
