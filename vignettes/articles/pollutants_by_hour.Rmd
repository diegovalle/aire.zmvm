...
include daylight savings time (basically GMT+6). It's probably a good idea to convert it to local Mexico City time if we want to analyse pollution patterns by hour of day.
